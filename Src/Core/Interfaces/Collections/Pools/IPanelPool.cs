...
namespace LinkLynx.Core.Interfaces.Collections.Pools
{
    ...
    public interface IPanelPool
    {
        ...
        /// </summary>
        TouchPanelDevice GetPanel(uint panelId);
        ...
        /// <param name="panel">The <see cref="TouchPanelDevice"/> instance representing the panel to add.</param>
        bool TryAddPanel(uint panelId, TouchPanelDevice panel);
    }
}
