...
{
    /// <summary>
    /// The ISerialJoinDispatcher interface defines a contract for managing a collection of actions
    /// </summary>
    public interface ISerialJoinDispatcher
    {
        /// <summary>
        ...
        /// </summary>
        bool TryAdd(uint joinId, Action<PageLogicScript, SignalEventData> action);
        ...
        /// </summary>
        Action<PageLogicScript, SignalEventData> Get(uint joinId);
    }
}
